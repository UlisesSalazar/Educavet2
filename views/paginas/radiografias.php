<main class="radiografiaRx">
    ...
    <section class="imagenes">
        ...
        <p class="imagen__fecha">Las cuadriculas o rejillas, se utilizan para absorber los residuos dispersos de la radiación. Clinical Radiology of the Horse(2008).Blackwell(3th ed.)[PDF.file].</p>
