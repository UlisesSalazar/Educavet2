<header class = "header">
    ...
    <div  data-aos="fade-down"
     ...
     data-aos-duration="1500" class="header__contenido">
        <a href="/">
    ...
    <div class="barra">
        <div class="barra__contenido">
            ...
            <nav class="navegacion">
                ...
                <a href="/peso" class="navegacion__enlace <?php echo pagina_actual('/peso') ? 'navegacion__enlace--actual' : ''; ?>">Peso del caballo</a>
            </nav>
        </div>
    </div>